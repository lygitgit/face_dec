...
from fast_reid.fastreid.modeling.backbones.resnet import Bottleneck, BasicBlock
...
class MGN(nn.Module):
    ...
    def from_config(cls, cfg):
        ...
        # for res34
        # res_p_conv5 = nn.Sequential(
        #     BasicBlock(256, 512, bn_norm, False, with_se, downsample=nn.Sequential(
        #         nn.Conv2d(256, 512, 1, bias=False), get_norm(bn_norm, 512))),
        #     BasicBlock(512, 512, bn_norm, False, with_se),
        #     BasicBlock(512, 512, bn_norm, False, with_se))
